...
function get_the_content($more_link_text = '(more...)', $stripteaser = 0, $more_file = '') {
	...
	global $pagenow;
	$output = '';
	$more_link_text = __($more_link_text);//vec - Lime
...
function get_the_password_form() {
	...
	$output = '<form action="' . get_option('siteurl') . '/wp-pass.php" method="post">
	<table>
	<tr><td class="logbody">' . __("This post is password protected. To view it please enter your password below:") . '</td></tr>
	<tr><td class="commentform-pass">' . __("Password:") . '</td></tr>
	<tr><td class="commentform-pass"><input class="inputbox1-pass" name="post_password" type="password" size="20"></td></tr>
	<tr><td class="commentform-pass"><input class="button-pass" type="submit" name="Submit" value="' . __("Submit") . '"></td></tr>
	</table>
	</form>
	';//vec - Lime
	return $output;
