<?php get_header(); ?>
	...
	<table class="log">
	  <tr>
			<?php if(is_category()) { ?>
		<td class="singleleft"><?php next_post_link('&#60;&#60;&nbsp;%link', in_same_cat) ?></td>
		<td class="singleright"><?php previous_post_link('%link&nbsp;&#62;&#62;', in_same_cat) ?></td>
			<?php }else { ?>
		<td class="singleleft"><?php next_post_link('&#60;&#60;&nbsp;%link') ?></td>
		<td class="singleright"><?php previous_post_link('%link&nbsp;&#62;&#62;') ?></td>
			<?php } ?>
	  </tr>
	</table>
					...
					<table class="log">
					  <tr>
						...
						<td class="logfootprop">
							<?php the_time('Y.m.d') ?> <b>::</b> <?php the_author() ?>
						</td>
					  </tr>
					</table>
				</td>
